...
// Full Track-1 protected surface (Gate1-Prompt-Pipeline-TZ.md Revision 2,
// section 6) — deliberately wider than the Formatter contract test's
// TRACK1_PATHS, which only covers types.ts/builder/*.
const TRACK1_PATHS = [
